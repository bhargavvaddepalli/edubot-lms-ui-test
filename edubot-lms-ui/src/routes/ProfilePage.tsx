...
function ProfilePage() {
  ...
  // Check if the input value contains any numbers (using regex)
  if (/\d/.test(value)) {
    alert("Name invalid: Numbers are not allowed.");
    return; // Stop further execution if numbers are found
  }
  ...
  <PhoneInput
    ...
    inputClass="tw-w-full tw-border-2 tw-rounded-md tw-p-2 !tw-min-w-full"
    containerClass="tw-w-full"
    buttonClass="tw-border-2"
  />
</div>
          ...
          <div>
            <div className="tw-max-w-lg tw-mx-auto tw-mt-6 tw-bg-white tw-rounded-lg tw-p-6 tw-border-2 tw-border-gray-300 tw-ml-6 tw-pr-20">
              ...
              <input
                ...
                onChange={handleChange}
                className="tw-w-full tw-border-2 tw-p-2 tw-rounded-md tw-mb-3"
              />
              ...
              <input
                type="text"
                name="universitySpecialization"
                value={formData.universitySpecialization}
                onChange={handleChange}
                className="tw-w-full tw-border-2 tw-p-2 tw-rounded-md tw-mb-3"
              />
            ...
            <button
              type="submit"
              className="tw-bg-blue-800 tw-text-white tw-font-bold tw-w-lg tw-p-3 tw-pl-6 tw-pr-6 tw-rounded-md tw-ml-60 tw-mt-4 tw-flex tw-items-center"
            >
              Update
            </button>
          </div>
