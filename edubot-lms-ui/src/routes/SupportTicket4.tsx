...
export const Route = createFileRoute("/SupportTicket4")({
  component: () => {
    ...
    return (
      <div className="tw-min-h-screen tw-bg-[#F8F9FA] tw-text-black-900">
        ...
        <div className="tw-max-w-6xl tw-mx-auto tw-p-6">
          ...
          <div className="tw-flex tw-items-center tw-justify-between tw-mt-6">
            <div className="tw-flex tw-items-center tw-gap-3">
              ...
              <div className="tw-flex tw-items-center tw-gap-2 tw-bg-white tw-rounded-md tw-ml-3">
                <span className="tw-text-sm tw-text-black-500 tw-border-black-300 tw-border-black-700 tw-rounded-md tw-ml-3">
                  Assign to
                </span>
                <span className="tw-text-black-400">|</span>
            ...
            <Button
              variant="outline"
              className="tw-h-10 tw-px-4 tw-text-sm tw-font-medium tw-rounded-md"
          ...
          {/* Comment Box (Appears When Button Clicked) */}
          {showCommentBox && (
            <div className="tw-mt-4 tw-bg-gray-100 tw-p-4 tw-rounded-md">
              <textarea
                className="tw-w-full tw-h-20 tw-p-2 tw-border tw-rounded-md"
              ...
              <div className="tw-flex tw-justify-end tw-mt-2">
                <Button
                  className="tw-bg-blue-900 tw-text-white"
                  onClick={() => {
